...
all_episodes <-  read_sheet(data_for_prog_url, sheet="all_rankings", col_names=TRUE
...
all_rankings <- read_sheet(data_for_prog_url, sheet="all_contestants", col_names=TRUE
