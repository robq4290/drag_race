...
# Writing tables to a sqlite database for data checks 

Will only be keeping non-redundant data
```{r create sqlitedb and frames, echo=FALSE, include=FALSE}
